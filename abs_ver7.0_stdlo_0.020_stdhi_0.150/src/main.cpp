...
// std_lo = 0.020 cm^-1 and std_hi = 0.150 cm^-1.
//
...
//   STEP 2/4 STD LO   Insert 0.020 std, press B -> low-std measurement
//   STEP 3/4 STD HI   Insert 0.150 std, press B -> high-std measurement
//                                             -> derive m and b
...
//                   (default 0.020). Live-updates m,b if both standards
//                   have been measured.
