"""Plot long_experiment_2.csv (columns: t_s, adc, volts, led)."""
...
CSV       = "long_experiment_2.csv"
OUT_TS    = "long_experiment_2.png"
OUT_HIST  = "long_experiment_2_hist.png"
SUPTITLE  = ("Long LED experiment #2 (ItsyBitsy M0, TCC0 NPWM 200 Hz, "
             "12-bit ADC, coherent averaging 50 subsamples / 5 periods)")
