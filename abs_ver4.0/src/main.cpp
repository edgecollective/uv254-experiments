// Absorbance measurement firmware, ItsyBitsy nRF52840, ver4.0 variant.
//
...
static void render() {
  ...
  // Version tag, top-right corner ("ver4.0" = 6 chars * 6 px = 36 px wide).
  display.setCursor(OLED_W - 6 * 6, 0);
  display.print("ver4.0");
...
void setup() {
  ...
  Serial.println("# ver4.0 (nRF52840) ready");
