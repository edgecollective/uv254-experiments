"""Plot led_average/exp1_10hz_2sec.csv (columns: t_s, adc, volts, led)."""
...
CSV      = "exp1_10hz_2sec.csv"
OUT_TS   = "exp1_10hz_2sec.png"
OUT_HIST = "exp1_10hz_2sec_hist.png"
SUPTITLE = ("led_average exp1 (ItsyBitsy M0, TCC0 NPWM 200 Hz, 12-bit ADC, "
            "20-sample avg @ 10 Hz -> row every 2 s)")
...
ax_adc.set_ylabel("ADC count (12-bit, 20-sample avg)")
